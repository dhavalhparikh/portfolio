...
<html lang="en">
    <head>
        <!-- Inspired from https://eventline.surebot.io/ -->
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <ul class="buttons" id="buttons02">
                        <li>
                            <a target="_blank" href="/dev/files/dhaval_resume.pdf" class="button n02">About me</a>
                        </li>
                        <li>
                    ...
                    <!-- <p id="text01">
                        Built by <a href="https://www.linkedin.com/in/dhavalparikh26">Dhaval Parikh</a>
                    </p> -->
                    <ul class="icons" id="icons01">
                        <li>
                            <a class="n01" target="_blank" href="https://github.com/dhavalhparikh" title="GitHub">
                                <svg>
                        ...
                        <li>
                          <a class="n05" target="_blank" href="https://www.linkedin.com/in/dhavalparikh26" title="LinkedIn">
